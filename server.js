    ...
    db.query(checkExists, [username], function (err, results, fields) {
        ...
        bcrypt.genSalt(10, function (err, salt) {
            ...
            bcrypt.hash(pass, salt, function (err, hash) {
                ...
                const q = `INSERT INTO server(serverid, username, hash, fname, lname, ruemail, category, service) VALUES (null, ?, ?, ?, ?, ?, ?, ?)`;
                db.query(q, [username, hash, fname, lname, ruemail, category, service], function (err, results, fields) {
